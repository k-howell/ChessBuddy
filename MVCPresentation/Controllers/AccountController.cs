    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                try
                {
                    if(userMgr.GetUserByUserName(model.UserName) != null)
                    {
                        var oldUser = userMgr.AuthenticateUser(model.UserName, model.Password);
                        oldUser.Roles = userMgr.GetUserRoles(oldUser.UserName);
                        if(oldUser == null)
                        {
                            // incorrect password
                            return View(model);
